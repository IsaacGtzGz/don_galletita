...
class DetalleCompra(models.Model):
    ...
    def __str__(self):
        return f"Detalle {self.detalle_compra_id} - Compra {self.compra.compra_id} - Insumo {self.insumo.nombre_insumo} ({self.unidad_medida})"


class ProductoAlmacenado(models.Model):
    ...
    def __str__(self):
        return f"Producto {self.insumo.nombre_insumo} - Cantidad {self.cantidad_disponible} ({self.unidad_medida})"